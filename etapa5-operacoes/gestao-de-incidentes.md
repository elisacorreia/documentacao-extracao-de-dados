Aqui está a transcrição exata do conteúdo solicitado, formatada em Markdown (`.md`) para melhor legibilidade, mantendo todo o conteúdo original.
    ...
    rules:
      - alert: ServiceDown
        ...
        annotations:
          ...
          runbook: "[https://wiki.hotel.com/runbook/service-down](https://wiki.hotel.com/runbook/service-down)"
...
global:
  resolve_timeout: 5m
  slack_api_url: '[https://hooks.slack.com/services/YOUR/SLACK/WEBHOOK](https://hooks.slack.com/services/YOUR/SLACK/WEBHOOK)'
